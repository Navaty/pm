...
/**
    ...
    function get_javascript_translation()
    {
        ...
        $sazanCacheRes = sazanIsCached('get_javascript_translation', $inData, 60 * 60 * 24);
        if ($sazanCacheRes['status']) {
            $content = $sazanCacheRes['result'];
            $timeDiff = 'exists ';
            ...
            $content .= "\n/* end */\n";
            sazanCache('get_javascript_translation', $inData, $content);
        }
