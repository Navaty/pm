...
include("uslugi2.feedback.design.20111031.php");
break;
//echo "<"."? echo rand();?".">";
include ("db.inc.php");
...
$stat_button = "<br/><div id=stat1><a href='/feedback/new-form?&stat=true'><img src='http://pm.citrt.net/plugins/dimages/stat.jpg'/></a></div>";
...
<!--    <h3>Часто задаваемые вопросы</h3>-->
    <div id=\"allfaq\"><a href=\"#\" onclick=\"goto_faq()\"><img src='http://pm.citrt.net/plugins/dimages/faq.png'/></a></div>
    ".$faqhtml."
    <div class=\"simple-buttons\">
     <div id=\"newfeedback\" class=\"inputs_hide\" style=\"display:none;\"><p onclick=\"goto_feedback();\"><ins><input type=\"button\">Хочу задать новый вопрос</ins></p></div>
    </div>
    ";
?>
...
<form action="" method="POST">
  ...
  <table width="960" cellpadding="0" cellspacing="0" border="0">
	...
	<?=$appeal_description;?>
        <?=$appeal_contacts;?>
																<div class="simple-buttons" style="width:600px;text-align: center;">
	  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<p><ins><input type="submit" name="action_send" value=" .">Отправить</ins></p>
     </div>
      </td>
