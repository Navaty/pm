...
<script>
   $(function() {
    $( ".buttonset" ).buttonset();
            ...
            $html .= make_wrapper($name, $input, "</div><br>");//третий вместо коммента
...
<script>
      ...
      $(".timepicker").timepicker({
       ...
       minuteGrid: 10
            ...
            $html .= make_wrapper($name, $value, "</div><br>"); // 3 coment
        } else {
...
function make_appeal_form()
{
  ...
  <textarea class="textarea textarea-autoresizeonload ready2clear" name="appeal" style="width: 50%;"></textarea>';
    return $html;
}
