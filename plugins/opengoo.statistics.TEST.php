...
<body>
<?#print_r($_REQUEST);?>
<form action="http://pm.citrt.net/plugins/opengoo.statistics.TEST.php" method="POST">
  <table cellpadding="5">
    <tr>
...
foreach($tasks["open"] as $k=>$v) {
  echo "<a href='http://pm.citrt.net/index.php?c=task&a=view_task&id={$k}'>{$k}</a><br/>";
}
echo "<tr>
