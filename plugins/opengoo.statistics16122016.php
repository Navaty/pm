...
<body>
<?#print_r($_REQUEST);?>
<form action="http://pm.citrt.net/plugins/opengoo.statistics16122016.php" method="POST">
  <table cellpadding="5">
    <tr>
...
<select name="projectid" id="projectid">
  <option value=684 <? if($projectid=="684"){ echo "selected";}?>>Жалобы МИС РТ</option>
    ...
    <option value=4071 <? if($projectid=="4071"){ echo "selected";}?>>ТП zdrav.tatar.ru</option>
    <option value=3336 <? if($projectid=="3336"){ echo "selected";}?>>Подача заявлений на предоставление земель многодетным семьям</option>
