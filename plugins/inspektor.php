...
if($_POST && $_POST['appeal']){
  ...
  $Data		= $_POST;
  $Subscrip	= array("user_id"=>array(217,325,316,644,472,522,616,556,345));
...
//385-Мансурова Фарюза;522-Кузьмина Алина;616-Григорян Нарине;556-Гарипова Резеда;345-Хабибрахманова Эльвира
