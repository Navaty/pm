...
function moderator($Data) {
  $userid = $_REQUEST["http___pm_citrt_netid"];
    $moderator_button = "<iframe src=\"/plugins/EDUHELPPublish.php?commentid=".$Data."&userid=".$userid."\" scrolling=\"no\" frameborder=\"no\"  width=\"120\" height=\"40\" align='left'></iframe>";
