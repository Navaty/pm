...
//									echo '     Предыдущее время редактирования'.$edit_task_on_prev.' ID компании '.$res_time[$i-1]["company_id"].'<br /><br />   Потрачено времени '.$edittask.' - '.$edittask_prev.' = '.($edittask - $edittask_prev).'<br />';
                ...
                $active_sheet->setCellValue('B' . $schetchik_excel, date("d.m.y"));
...
$verstka .= '</table>';
$ToID = array('Andrey.C@tatar.ru', 'A.H@tatar.ru', 'Timur.Zaripov@tatar.ru', 'L.G@tatar.ru', 'Elena.Lukina@tatar.ru', 'Aygul.Komarova@tatar.ru', 'Yuliya.Starikova@tatar.ru', 'katkov@infomatika.ru', 'Irina.Kireeva@tatar.ru', 'Adeliya.Zhilkina@tatar.ru', 'Ibragimov.Ruslan@tatar.ru', 'Aygul.Hamadeeva@tatar.ru', 'Marat.Shigapov@tatar.ru', 'Maksim.R.Isaev@tatar.ru');
//$ToID = array('Andrey.C@tatar.ru', 'A.H@tatar.ru');
